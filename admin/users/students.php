        ...
        <div class="card-body" id="form-container">
          <?php if ($_GET['action'] == 'add-new') { ?>
            ...
            <fieldset class="border border-secondary p-3 form-group">
                <legend class="d-inline w-auto h6">Only For Acadamy</legend>
                <div class="row">
                 
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label for="">Enrollment Number</label>
                      <input type="text" required class="form-control" placeholder="DOB" name="dob" readonly>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="form-group">
  ...
  jQuery(document).ready(function(){
    jQuery('#users-table').DataTable({
      ...
      columns: [
          ...
          { data: 'mother_name' ,orderable: false},
          { data: 'doa',orderable: false},
