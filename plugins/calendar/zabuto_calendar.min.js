            ...
            data: function () {
                ...
                if (null === handle) {
                    ...
                    if('data' in ajaxSettings){
                        if('year' in ajaxSettings.data){
                            ajaxSettings.data.year = ajaxSettings.data.year;

                        }else{
                            ajaxSettings.data.year = element.data('year');
                        }
                        if('month' in ajaxSettings.data){
                            ajaxSettings.data.month = ajaxSettings.data.month;
                        }else{
                            ajaxSettings.data.month = element.data('month');
                        }
                    }else{
